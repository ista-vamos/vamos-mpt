...
#define MAX_NUM_EVS 10
const size_t lens[] = {10, 8};
TraceEvent streams[][MAX_NUM_EVS] = {
    {Event_InputL(1, addr, 1), Event_InputL(2, addr, 2), Event_Write(4, addr, 5),
     Event_InputL(3, addr, 3),

     Event_OutputL(1, addr, 1), Event_OutputL(2, addr, 2), Event_Write(4, addr, 5),
     Event_OutputL(3, addr, 3),

     Event_Write(4, addr, 5), Event_Write(4, addr, 5)},
    {
        Event_InputL(1, addr, 1),
        Event_Write(4, addr, 5),
